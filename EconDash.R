...
##Retrieve Data
##Real Gross Domestic Product, Percent Change from Quarter One Year Ago, Seasonally Adjusted (A191RO1Q156NBEA)
##Housing Starts: Total: New Privately Owned Housing Units Started, Thousands of Units, Seasonally Adjusted Annual Rate (HOUST) 
##Civilian Unemployment Rate, Percent, Seasonally Adjusted (UNRATE)
##U.S. / Euro Foreign Exchange Rate, U.S. Dollars to One Euro, Not Seasonally Adjusted (AEXUSEU)
##University of Michigan: Consumer Sentiment©, Index 1966:Q1=100, Not Seasonally Adjusted (UMCSENT)
##Industrial Production Index, Index 2012=100, Seasonally Adjusted (INDPRO)
##Real Median Household Income in the United States, 2014 CPI-U-RS Adjusted Dollars, Not Seasonally Adjusted (MEHOINUSA672N)
##Global price of Brent Crude, U.S. Dollars, Not Seasonally Adjusted (POILBREUSDM)
##Consumer Price Index for All Urban Consumers: All Items, Index 1982-1984=100, Seasonally Adjusted (CPIAUCSL)
##Light Weight Vehicle Sales: Autos and Light Trucks, Millions of Units, Seasonally Adjusted Annual Rate (ALTSALES)
##Personal Consumption Expenditures, Billions of Dollars, Seasonally Adjusted Annual Rate (PCE)
